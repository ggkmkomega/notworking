...
@section('section-content')
    <div class="input-section ticket-wrapper">
        <form action="{{route('newTicket')}}" method="get">
            @csrf
            <div><input style="width:400px; height:36px;" type="text" name="title" placeholder="Titre"></div>
            <div class="custom-select" style="width:400px; margin-left:10px;">
            <select name="type">
                <option selected disabled>Sélectionnez votre type de problème</option>
